...
\includegraphics[width=0.5\textwidth, angle=0]{SIM_m=0.05.pdf}
};

\node[inner sep=0pt] (cgm:0.05) at (6.5,0) {
\includegraphics[width=0.5\textwidth, angle=-1]{CGM_m=0.05.pdf}
};

\node[inner sep=0pt] (sim:0.05) at (0,-5) {
\includegraphics[width=0.5\textwidth, angle=0]{SIM_m=0.5.pdf}
};

\node[inner sep=0pt] (cgm:0.05) at (6.5,-5) {
\includegraphics[width=0.5\textwidth, angle=-1]{CGM_m=0.5.pdf}
};

\node[inner sep=0pt] (sim:0.05) at (0,-10) {
\includegraphics[width=0.5\textwidth, angle=0]{SIM_m=0.95.pdf}
};

\node[inner sep=0pt] (cgm:0.05) at (6.5,-10) {
\includegraphics[width=0.5\textwidth, angle=-1]{CGM_m=0.95.pdf}
};
